...
- **Next up**: swap the bootstrap DDL for Drizzle Kit migrations, add per-user AI rate limits, and extend audit coverage to page publish + integration credential changes.
